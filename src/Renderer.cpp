...
void Renderer::CreateComputeDescriptorSets() {
    ...
    for (uint32_t i = 0; i < scene->GetBlades().size(); ++i) {
        ...
        VkDescriptorBufferInfo culledBladesladesBufferInfo = {};
        culledBladesladesBufferInfo.buffer = scene->GetBlades()[i]->GetCulledBladesBuffer();
        culledBladesladesBufferInfo.offset = 0;
        culledBladesladesBufferInfo.range = NUM_BLADES * sizeof(Blade);
        ...
        descriptorWrites[3 * i + 1].pBufferInfo = &culledBladesladesBufferInfo;
...
void Renderer::RecordCommandBuffers() {
    ...
    for (size_t i = 0; i < commandBuffers.size(); i++) {
        ...
        clearValues[0].color = { 0.594f, 0.746f, 0.867f, 1.0f };
